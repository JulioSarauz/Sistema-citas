...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Selah Wellness";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "hola@selah.wellness.ec";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Selah Wellness";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Selah";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Selah Wellness";
